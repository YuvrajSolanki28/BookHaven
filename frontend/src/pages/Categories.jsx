...
function Categories() {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get(`${import.meta.env.BACKEND_URL}/api/books/categories`);
  ...
  const fetchBooksByCategory = async (category) => {
    try {
      const response = await axios.get(`${import.meta.env.BACKEND_URL}/api/books/category/${category}`);
